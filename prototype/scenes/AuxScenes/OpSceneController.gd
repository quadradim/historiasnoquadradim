	...
	$PlayerEntity.insert(
		{
			"name": "none",
			"habilities": [],
			"backpack": "res://assets/Images/CharacterChoice/mochilas/mochila01.png",
...
<<<<<<< Updated upstream:prototype/scripts/OpSceneController.gd
	var initial_scene = "analyze_photos"
=======
	var initial_scene = "menu"
>>>>>>> Stashed changes:prototype/scenes/AuxScenes/OpSceneController.gd
	load_control_scene(
